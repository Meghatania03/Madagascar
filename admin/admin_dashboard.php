...
$animals = mysqli_query($conn, "
    SELECT a.animal_id, a.name, a.species, a.age, a.health_status, a.image, a.caretaker_id, e.name AS enclosure_name
    FROM Animal a
    JOIN Enclosure e ON a.enclosure_id=e.enclosure_id
");

// --- Fetch all staff with their animals ---
...
// --- Fetch enclosures & caretakers for forms ---
...
// --- Fetch staff list for feeding schedule script ---
...
if(isset($_POST['add_animal'])){
    $name=$_POST['name']; $species=$_POST['species']; $age=$_POST['age']; $health=$_POST['health'];
    $enclosure=$_POST['enclosure']; $caretaker=$_POST['caretaker'];
    ...
    echo "<script>alert('Animal added successfully!');window.location.href='admin_dashboard.php';</script>";
}

// --- Add Feeding Task ---
if(isset($_POST['add_feeding'])){
    $animal=$_POST['animal']; $food=$_POST['food_name']; $quantity=$_POST['quantity'];
    $time=$_POST['feeding_time']; $feed_by=$_POST['feed_by'];
...
.container {max-width:1000px;margin:30px auto;background:white;padding:20px;border-radius:10px;box-shadow:0 0 10px rgba(0,0,0,0.2);}
h2 {color:#2e8b57;}
...
<table>
<tr>
<th>Image</th><th>Name</th><th>Species</th><th>Age</th><th>Health</th><th>Enclosure</th><th>Actions</th>
</tr>
...
<table>
<tr><th>Animal</th><th>Feeding Time</th><th>Food</th><th>Quantity</th><th>Feed By</th></tr>
...
<table>
<tr><th>Name</th><th>Role</th><th>Email</th><th>Phone</th><th>Animals</th><th>Actions</th></tr>
...
<h2>Visitors</h2>
<table>
<tr><th>Name</th><th>Email</th><th>Phone</th><th>Visit Date</th></tr>
...
<table>
<tr><th>Enclosure</th><th>Type</th><th>Total Animals</th><th>Average Age</th></tr>
...
animalSelect.addEventListener('change',function(){
    ...
    if(caretakerId && staffData[caretakerId]){
        ...
        opt.value=caretakerId; opt.textContent=staffData[caretakerId];
